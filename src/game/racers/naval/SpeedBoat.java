 ...
 *  basically its set an speedBoat racer that derived from Racer class and extents it
...
public class SpeedBoat extends Racer implements NavalRacer {
     ...
     *  first we set the racerName speedBoat as default 'SpeedBoat' with it serial number
     *   then we set a default MaxSpeed & Acceleration for speedBoat (75, 10)
     *    finally we set default Color and Team and Type for speedBoat (RED, DOUBLE, SKULLING)
     */
    public SpeedBoat() {
        super();
